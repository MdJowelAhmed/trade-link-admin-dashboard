...
import {  ListRestartIcon, Pencil, Trash2 } from 'lucide-react'
...
interface LocationCardProps {
    ...
    onActivateWithChildren?: (location: LocationEntity) => void
    ...
    return (
        ...
        >
            <Card className="h-full hover:shadow-md transition-shadow">
                <CardContent className="h-full px-5 py-4 flex flex-col gap-3">
                        ...
                        <div className=" flex gap-4">
                            ...
                            {onActivateWithChildren && (
                                <button
                                    type="button"
                                    className="rounded-full  border-none"
                                    onClick={() => onActivateWithChildren(location)}
                                    title="Activate with all children"
                                >
